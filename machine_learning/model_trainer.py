    ...
    def train_model(self, random_state=42):
        ...
        try:
            ...
            if X.empty or len(y) < 10:
                logger.warning(
                    "Not enough data to train a model. Need at least 10 samples."
                )
            ...
            top_features = feature_selector.get_top_features(
                X_test, X.columns, top_n=4
            )  # Increased to top 4 features
