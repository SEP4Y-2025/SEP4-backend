...
class SoilHumidityPredictionService:
    ...
    def predict_future_humidity(self, plant_pot_id=None, minutes_ahead=5):
        try:
            ...
            evaporation_rate = max(0.001 * minutes_ahead, evaporation_rate)  # Ensure some minimal drying
            ...
            result = {
                "plant_pot_id": latest_data['plant_pot_id'].iloc[0] if 'plant_pot_id' in latest_data.columns else plant_pot_id or "unknown",
                ...
                "physical_constraints_applied": current_soil_humidity is not None and predicted_humidity < current_soil_humidity
            }
