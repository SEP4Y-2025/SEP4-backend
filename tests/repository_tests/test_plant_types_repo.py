...
def test_get_all_plant_types(plant_types_repo):
    ...
    all_plants = plant_types_repo.get_plant_types_by_environment("680f8359688cb5341f9f9c19")
...
def test_get_plant_type_by_id_not_found(plant_types_repo):
    fetched = plant_types_repo.get_plant_type_by_id(ObjectId("680f8359688cb5341f9f9c18"))
